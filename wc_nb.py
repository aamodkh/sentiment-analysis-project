...
df = pd.read_csv('data/naive_bayes_results.csv')
...
for index, row in df.iterrows():
    ...
    predicted_label_positive = predicted_label_neutral = predicted_label_negative = row['predicted']
...
wordcloud.to_file("img/nb_actual_positive.png")
plt.figure()
...
image_colors = ImageColorGenerator(face)
wordcloud.recolor(color_func=image_colors)
wordcloud.to_file("img/nb_predicted_positive.png")
plt.figure()
plt.imshow(wordcloud, interpolation="bilinear")
plt.axis("off")
plt.show()
...
image_colors = ImageColorGenerator(face)
wordcloud.recolor(color_func=image_colors)
wordcloud.to_file("img/nb_actual_neutral.png")
plt.figure()
plt.imshow(wordcloud, interpolation="bilinear")
plt.axis("off")
plt.show()
...
image_colors = ImageColorGenerator(face)
wordcloud.recolor(color_func=image_colors)
wordcloud.to_file("img/nb_predicted_neutral.png")
plt.figure()
plt.imshow(wordcloud, interpolation="bilinear")
plt.axis("off")
plt.show()
...
image_colors = ImageColorGenerator(face)
wordcloud.recolor(color_func=image_colors)
wordcloud.to_file("img/nb_actual_negative.png")
plt.figure()
plt.imshow(wordcloud, interpolation="bilinear")
plt.axis("off")
plt.show()
...
image_colors = ImageColorGenerator(face)
wordcloud.recolor(color_func=image_colors)
wordcloud.to_file("img/nb_predicted_negative.png")
plt.figure()
plt.imshow(wordcloud, interpolation="bilinear")
plt.axis("off")
plt.show()
